...
export async function sendPostcardEmail({
  ...
  await resend.emails.send({
    ...
    to,
    subject: `${fromName} sent you a postcard`,
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <p>${safeName} sent you a postcard:</p>
        <blockquote style="border-left: 3px solid #ccc; padding-left: 12px; color: #555;">${safePreview}</blockquote>
